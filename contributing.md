...
To develop the project locally, you'll need a recent version of Node.js and `pnpm` v1 installed globally.
...
Once you have `react-notion-x` set up locally, run `pnpm link` from each `react-notion-x` package:
